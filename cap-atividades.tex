...
\label{sec:atividades}
  ...
  \label{sec:atividades:origem}
    ...
    \footnotetext{
      ...
      \url{uspgamedev.org} (última acesso: 15/09/2013).
    }
  ...
  cada linguagem que se deseja ser compatível com a OPA. O \LangWrap{} representa a máquina
  ...
  da implementação do \LangWrap{} que representa a máquina virtual responsável pelo
  \VData{} em questão.
