...
\materia{MAC0316}{Conceitos Fundamentais de Linguagens de Programação}{
  ...
  programação bem simples a a máquina virtual dela, apesar de não chegarmos
...
\materia{MAC0342}{Laboratório de Programação Extrema}{
  ...
  do caminho). O mais importante que aprendi foi a saber priorizar aquilo que
  agrega mais valor na hora de desenvolver um \textit{software}, evitando de
  perder tempo com código que dá trabalho e não acrescenta nada.
}
...
\materia{MAC0414}{Linguagens Formais e Autômatos}{
  ...
  precisava analisar código em \CXX{}. Por mais que tenhamos usado o Flecc++
  ...
  consiguiríamos corrigí-los - não sem ter que pesquisar um monte e quebrar a
  cabeça pra caramb, pelo menos - sem o conhecimento que essa disciplina nos
  trouxe.
}
