...
\materia{MAC0211}{Laboratório de Programação I}{
  ...
  diversas ferramentas ensinadas ao longo da ementa: Makefile, LaTeX, flex e
...
\materia{MAC0316}{Conceitos Fundamentais de Linguagens de Programação}{
  ...
  programação bem simples, montando a máquina virtual dela, apesar de não chegarmos
...
\materia{MAC0414}{Linguagens Formais e Autômatos}{
  ...
  consiguiríamos corrigir a nossa parte dos analisadores sem o conhecimento
  que essa disciplina nos trouxe --- pelo menos não sem ter que pesquisar um
  monte e quebrar a cabeça pra caramba.
}
