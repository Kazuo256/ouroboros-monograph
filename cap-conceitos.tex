...
\label{cap:conceitos}
  ...
  \label{cap:conceitos:apis}
    ...
    \end{lstlisting}
      ...
      Segue um exemplo de construção de um módulo ``\lang{native}'' que contém
      apenas a função \lang{native\_pow} que acamos de mostrar:
    ...
    \end{lstlisting}
      ...
      bilbioteca dinâmica\footnotemark{} com o nome ``\lang{native.so}'' em um
