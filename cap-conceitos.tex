...
\label{cap:conceitos}
  ...
  \label{cap:conceitos:apis}
    ...
    A API \C{} do Python é bem compreensiva e documentada, com muitas funções e
    ...
    (uma lista ou uma tupla em Python, por exemplo, usam esse protocolo) -
    ...
    quando ela processa código em Python, o usuário que usar a API \C{} tem que incrementar e 
    ...
    e operações que podem ser usadas por outros módulos. No entanto, no Python não há diferença
    entre ambos. Ao importar um \script{} Python, ele será executado e quaisquer operações
    declaradas nele serão realizadas, assim como quaisquer definições se tornaram acessíveis
