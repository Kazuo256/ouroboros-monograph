\chapter{Estado Atual do Projeto}
...
A libouroboros, que é basicamente uma biblioteca para \CXX{} contendo o OPA,
...
no Linux. As implementações das interfaces abstratas da OPA para as linguagens
...
(mais sobre como usar ele na próxima seção). Caso queira, as seguintes opções podem ser
