...
ela é composto por duas grandes partes, uma responsável por incorporar
...
exigiam que o nosso sistema fornecesse.
...
\begin{description}
  ...
  \item[\textit{Milestone} 2:] Na terceira \textit{milestone} nós testamos se os
    \script{s} eram capazes acessar os sub-módulos exportados diretamente, além
  ...
  \item[\textit{Milestone} 5:] Finalmente na sexta \textit{milestone} resolvemos implementar algo
    ...
    para possibilitar que atributos, variáveis, paramêtros de funções e seus resultados
...
para as máquinas virtuais que processarão os \script{s}:
