...
objetivos principais do trabalho com relação à biblioteca que desenvolvemos.
...
Ao final, elaboramos com mais profundidade as ferramentas que \lang{Lua} e
\lang{Python} nos oferecem, para que fique mais fácil de entender o que
falamos demais capítulos do trabalho.

Tratamos, no terceiro capítulo (\ref{cap:atividades} - Atividades) sobre a
...
do projeto, assim como o que mudou quando o disvinculamos do grupo. Em seguida,
entramos em alguns detalhes da implementação do nosso sistema, que mostramos
estar dividido em duas grandes partes principais. Também desabafamos sobre
o SWIG, uma ferramente que nos ajudou inicialmente mas tornou-se uma
...
exemplificamos as funcionalidades, com alguns exemplos para facilitar.
Aproveitamos para deixar algumas instruções de uso, incluindo configuração e
compilação das partes relevantes do sistema.
