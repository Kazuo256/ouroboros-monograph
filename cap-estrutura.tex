...
\setcounter{defcnt}{0}
  ...
  \label{sec:estrutura:opwig}
    ...
    Isso compõe um método que funciona, mas traz dificuldades. A maior
    ...
    durante suas rotinas, pois as funções de inicialização já precisam estar criadas
    ...
    escrever o código adicional para as funções de inicialização a tempo de elas
    serem compiladas junto com o resto da aplicação. Isso seria feito por um
    outro programa, que obviamente precisa estar compilado antes da aplicação,
    uma vez que ele \emph{interfere} com o código dela. Dizemos que esse
    programa auxiliar é uma \emph{gerador de código}.
